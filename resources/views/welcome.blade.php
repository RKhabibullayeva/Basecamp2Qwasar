...
<html>
<head>
    <title>Basecamp.Khabibullayeva</title>
    <style>
body {
...
.navbar {
    --tw-bg-opacity: 1;
    background-color: rgb(50, 50, 100, var(--tw-bg-opacity));
    padding: 20px;
    display: flex;
...
<body>
    <nav class="navbar" style="padding: 7px; padding-left: 35px; padding-right: 35px;">
        <div class="navbar-title">
            <a class="basecamp_title" href="/"> <img class="basecamp-logo" src="images/basecamp.png" width="35px" height="35px"/><h4>BASECAMP</h4></a>
        </div>
        @if (Route::has('login'))
                <div class="">
                    @auth
    ...
    <div class="navbar-info">
        ...
        <p>Your team deserves less. Ditch the ineffective “stuff scattered everywhere” approach,
            and switch to Basecamp’s all-in-one project management platform..</p>
        <a href="{{ route('register') }}" class="mt-4 navbar-info-button">Try Basecamp for free </a>
    ...
    <ul class="features">
        <li class="feature-card">
            <h2 class="feature-card-title">Message Board</h2>
            <p class="feature-card-description">Say goodbye to long email threads.</p>
        </li>
        <li class="feature-card">
            <h2 class="feature-card-title">To-dos</h2>
            <p class="feature-card-description">Full team visibility, task by task.</p>
        </li>
        <li class="feature-card">
            <h2 class="feature-card-title">Docs & Files</h2>
            <p class="feature-card-description">No need to jump to another app to share files.</p>
        </li>
        <li class="feature-card">
            <h2 class="feature-card-title">Campfire</h2>
            <p class="feature-card-description">Ditch all the #channels, chat within each project.</p>
        </li>
        <li class="feature-card">
            <h2 class="feature-card-title">Schedule</h2>
            <p class="feature-card-description">Manage key dates, without spreadsheets or calendars.</p>
        </li>
        <li class="feature-card">
            <h2 class="feature-card-title">Card Table</h2>
            <p class="feature-card-description">Cancel status meetings, view progress in real-time.</p>
        </li>
    </ul>
